...
SNV scores are calculated for each cell by dividing the number of SNVs detected by the number of fragments that overlap an SNV.
...
::::: {.panelset}
```{r, fig.width=20, fig.height=20, results = 'asis'}
sampList <- unique(allSamples$sample) %>%   # Get a list of islands present in the dataset
    as.character()
walk(sampList, make_tab)     # make the tabs for each island that is there
```
:::::

## Comparing Cells with and without High Quality scATAC-seq
